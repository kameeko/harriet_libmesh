...
\end{equation}
%
represent the equation $\mathcal{M}'_{HF,\Psi}(\Psi_{HF})(\Phi)=0$ in residual form, where $\Phi$ is a test function. Also, let $\mathcal{Q}$ be an output defined by
%
\begin{equation}
...
\label{eq:superAdjEq}
\end{equation}
for the supplementary adjoint $\Lambda$.
