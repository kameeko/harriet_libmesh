...
int main(int argc, char** argv){
  ...
  mesh_refinement.uniformly_refine(2); //data should come from finer mesh
  ...
  //name system
  Diff_ConvDiff_Sys & system = 
  	equation_systems.add_system<Diff_ConvDiff_Sys>("Diff_ConvDiff_Sys");
