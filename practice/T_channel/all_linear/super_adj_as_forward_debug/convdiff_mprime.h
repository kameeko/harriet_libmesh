...
public:
  ...
  ConvDiff_MprimeSys(EquationSystems& es,
    ...
    if(FILE *fp=fopen(find_velocity_here.c_str(),"r")){
		...
		auxc_point_stash.resize(datavals.size()); //DEBUG
		c_point_stash.resize(datavals.size()); //DEBUG
  ...
  //velocity field
	...
	std::vector<std::vector<Real> > c_stash; std::vector<std::vector<Gradient> > gradc_stash;
	std::vector<std::vector<Real> > zc_stash; std::vector<std::vector<Gradient> > gradzc_stash;
	std::vector<std::vector<Real> > fc_stash; std::vector<std::vector<Gradient> > gradfc_stash;
	std::vector<std::vector<Real> > auxc_stash; std::vector<std::vector<Gradient> > gradauxc_stash;
	std::vector<std::vector<Real> > auxzc_stash; std::vector<std::vector<Gradient> > gradauxzc_stash;
	std::vector<std::vector<Real> > auxfc_stash; std::vector<std::vector<Gradient> > gradauxfc_stash;
	std::vector<Real> auxc_point_stash; std::vector<Real> c_point_stash;
