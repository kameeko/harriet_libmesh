...
void set_system_parameters(ConvDiffSys &system, FEMParameters &param)
{
    ...
    for (; a_step != param.max_adaptivesteps; ++a_step)
      {
        ...
        std::cout << "(Adjoint) Sensitivity of QoI to Peclet number is " << sensitivities_adj[0][0] << std::endl;
        std::cout << "(Forward) Sensitivity of QoI to Peclet number is " << sensitivities_for[0][0] << std::endl;
